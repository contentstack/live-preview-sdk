...
describe("FieldLabelWrapperComponent - Variant Indicator", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    ...
    test("renders VariantIndicator when field has variant", async () => {
        ...
        await waitFor(
            () => {
                // First, ensure the component is fully loaded by checking for the field-label-wrapper
                ...
                // Check that the variant class is applied (ensures isVariant state is set)
                if (
                ...
                // Now check for the variant indicator
