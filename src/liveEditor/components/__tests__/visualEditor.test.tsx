...
describe('VisualEditorComponent', () => {
  ...
  it('renders VisualEditorComponent correctly', () => {
    ...
    expect(getByTestId('visual-editor__overlay__wrapper')).toBeInTheDocument();
    expect(getByTestId('visual-editor__focused-toolbar')).toBeInTheDocument();
  });
  ...
  it('hides overlay and unobserves element on click', () => {
    ...
    const cursorElement = getByTestId('visual-editor__cursor');
  ...
  it('hides overlay without throwing error if VisualEditorGlobalState is null', () => {
    ...
    VisualEditor.VisualEditorGlobalState.value.previousHoveredTargetDOM = null
  ...
  it('unobserves element if VisualEditorGlobalState is null', () => {
    ...
    VisualEditor.VisualEditorGlobalState.value.previousSelectedEditableDOM = targetElement
